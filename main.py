...
st.markdown(f"<div class='header-container'><h1 class='main-title'>FORE CASTER</h1><h3 class='sub-title2'>SCREENING & BACKTEST | ver 3.4</h3></div>", unsafe_allow_html=True)
