...
with tab_top:
    ...
    with st.expander("🕒 市場指標ウォッチ (タップで開閉)", expanded=True):
        ...
        diag_html = f"""
        <div style="background-color: #1e2a3a; border: 1px solid #3d414b; border-radius: 6px; padding: 18px; margin-bottom: 15px;">
            ...
            <div style="margin-bottom: 15px; font-size: 0.8em;">{tips_str}</div>
        </div>
