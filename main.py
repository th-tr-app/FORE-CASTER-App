...
st.sidebar(f"<div class='header-container'><h6 class='main-title'>FORE CASTER</h6><p class='sub-title'>All-in-one Day trade manager | ver 4.96</p></div>", unsafe_allow_html=True) 
