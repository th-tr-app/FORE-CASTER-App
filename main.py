...
st.sidebar.markdown(
    """
    <div style='text-align: left; color: white;'><h6 style='margin-bottom: 0;'>FORE CASTER | ver 4.92</h6></div>
    <div style='text-align: left; color: white; font-size: 0.8em;'><p>All-in-one Day trade manager</p></div>
    """, 
