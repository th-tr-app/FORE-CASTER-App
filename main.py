...
st.markdown(f"<div class='header-container'><h1 class='main-title'>FORE CASTER</h1><p class='sub-title'>SCREENING & BACKTEST | ver 3.4</p></div>", unsafe_allow_html=True)
...
with tab_top:
    ...
    with st.expander("🕒 指標ウォッチ（タップで開閉）", expanded=False):
        ...
        <div class="ai-diagnosis-box">
            <h4 class="ai-diag-title">📀 今日のマーケットAI診断 <span style='font-size:0.8em; margin-left:10px; color:#00f0a8;'>{diag['alert_level']}</span></h4>
