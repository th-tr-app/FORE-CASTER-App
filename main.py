...
st.sidebar.markdown(
    ...
    <div style='margin-top: 50px; text-align: left;'>
        ...
        <p style='font-size: 0.8rem; color: #ffffff;'>All-in-one Day trade manager / ver 4.99</p>
    </div>
    """, 
...
with tab_top:
    ...
    if st.button("🔥 プランＢ／即時スキャン実行", type="secondary", use_container_width=True, key="btn_plan_b"):
