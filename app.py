...
# --- 3. マッピング & セッション管理 (日経225 + 5銘柄 計230銘柄) ---
TICKER_NAME_MAP = {
    ...
    "2432.T": "ディーエヌエー", "2501.T": "サッポロHD", "2502.T": "アサヒGHD", "2503.T": "キリンHD", "2768.T": "双日",
    "2801.T": "キッコーマン", "2802.T": "味の素", "2871.T": "ニチレイ", "2914.T": "JT", "3086.T": "Jフロント",
    "3092.T": "ZOZO", "3099.T": "三越伊勢丹", "3289.T": "東急不動産HD", "3382.T": "セブン&アイ", "3401.T": "帝人",
    "3402.T": "東レ", "3405.T": "クラレ", "3407.T": "旭化成", "3436.T": "SUMCO", "3659.T": "ネクソン",
    "3697.T": "SHIFT", "3861.T": "王子HD", "4004.T": "レゾナック", "4005.T": "住友化学", "4021.T": "日産化学",
    "4042.T": "東ソー", "4043.T": "トクヤマ", "4061.T": "デンカ", "4062.T": "イビデン", "4063.T": "信越化学",
    "4151.T": "協和キリン", "4183.T": "三井化学", "4188.T": "三菱ケミG", "4208.T": "UBE", "4307.T": "野村総研",
    "4324.T": "電通グループ", "4385.T": "メルカリ", "4452.T": "花王", "4502.T": "武田薬品", "4503.T": "アステラス製薬",
    "4506.T": "住友ファーマ", "4507.T": "塩野義製薬", "4519.T": "中外製薬", "4523.T": "エーザイ", "4543.T": "テルモ",
    "4568.T": "第一三共", "4578.T": "大塚HD", "4661.T": "オリエンタルランド", "4689.T": "ラインヤフー", "4704.T": "トレンド",
    "4751.T": "サイバーエージェント", "4755.T": "楽天グループ", "4819.T": "デジタルガレージ", "4901.T": "富士フイルム", "4902.T": "コニカミノルタ",
    "4911.T": "資生堂", "5019.T": "出光興産", "5020.T": "ENEOS", "5101.T": "横浜ゴム", "5108.T": "ブリヂストン",
    "5201.T": "AGC", "5202.T": "日本板硝子", "5301.T": "東海カーボン", "5332.T": "TOTO", "5333.T": "日本碍子",
    "5401.T": "日本製鉄", "5406.T": "神戸製鋼", "5411.T": "JFEHD", "5541.T": "大平洋金属", "5631.T": "日本製鋼所",
    "5703.T": "日本軽金属HD", "5706.T": "三井金属", "5707.T": "東邦亜鉛", "5711.T": "三菱マテリアル", "5713.T": "住友金属鉱山",
    "5714.T": "DOWA", "5801.T": "古河電気", "5802.T": "住友電気", "5803.T": "フジクラ", "5901.T": "東洋製罐GHD",
    "6098.T": "リクルートHD", "6103.T": "オークマ", "6113.T": "アマダ", "6178.T": "日本郵政", "6273.T": "SMC",
    "6301.T": "コマツ", "6302.T": "住友重機械", "6305.T": "日立建機", "6326.T": "クボタ", "6361.T": "荏原製作所",
    "6367.T": "ダイキン", "6471.T": "日本精工", "6472.T": "NTN", "6473.T": "ジェイテクト", "6479.T": "ミネベアミツミ",
    "6501.T": "日立製作所", "6503.T": "三菱電機", "6504.T": "富士電機", "6506.T": "安川電機", "6526.T": "ソシオネクス",
    "6532.T": "ベイカレント", "6594.T": "ニデック", "6645.T": "オムロン", "6674.T": "GSユアサ", "6701.T": "NEC",
    "6702.T": "富士通", "6723.T": "ルネサス", "6724.T": "セイコーエプソン", "6752.T": "パナソニックHD", "6753.T": "シャープ",
    "6758.T": "ソニーグループ", "6762.T": "TDK", "6770.T": "アルプスアルパイン", "6841.T": "横河電機", "6857.T": "アドバンテスト",
    "6861.T": "キーエンス", "6902.T": "デンソー", "6920.T": "レーザーテック", "6952.T": "カシオ計算機", "6954.T": "ファナック",
    "6971.T": "京セラ", "6976.T": "太陽誘電", "6981.T": "村田製作所", "6988.T": "日東電工", "7011.T": "三菱重工業",
    "7012.T": "川崎重工業", "7013.T": "IHI", "7186.T": "コンコルディア", "7201.T": "日産自動車", "7202.T": "いすゞ自動車",
    "7203.T": "トヨタ自動車", "7205.T": "日野自動車", "7211.T": "三菱自動車", "7261.T": "マツダ", "7267.T": "本田技研",
    "7269.T": "スズキ", "7270.T": "SUBARU", "7272.T": "ヤマハ発動機", "7453.T": "良品計画", "7731.T": "ニコン",
    "7733.T": "オリンパス", "7735.T": "SCREEN", "7741.T": "HOYA", "7751.T": "キヤノン", "7752.T": "リコー",
    "7832.T": "バンダイナムコ", "7911.T": "TOPPANHD", "7912.T": "大日本印刷", "7951.T": "ヤマハ", "7974.T": "任天堂",
    "8001.T": "伊藤忠商事", "8002.T": "丸紅", "8015.T": "豊田通商", "8031.T": "三井物産", "8035.T": "東京エレクトロン",
    "8053.T": "住友商事", "8058.T": "三菱商事", "8233.T": "高島屋", "8252.T": "丸井グループ", "8253.T": "クレディセゾン",
    "8267.T": "イオン", "8304.T": "あおぞら銀行", "8306.T": "三菱UFJ", "8308.T": "りそなHD", "8309.T": "三井住友トラ",
    "8316.T": "三井住友FG", "8331.T": "千葉銀行", "8354.T": "ふくおかFG", "8411.T": "みずほFG", "8601.T": "大和証券G",
    "8604.T": "野村HD", "8628.T": "松井証券", "8630.T": "SOMPOHD", "8697.T": "日本取引所G", "8725.T": "MS&AD",
    "8750.T": "第一生命HD", "8766.T": "東京海上HD", "8795.T": "T&DHD", "8801.T": "三井不動産", "8802.T": "三菱地所",
    "8804.T": "東京建物", "8830.T": "住友不動産", "9001.T": "東武鉄道", "9005.T": "東急", "9007.T": "小田急電鉄",
    "9008.T": "京王電鉄", "9009.T": "京成電鉄", "9020.T": "JR東日本", "9021.T": "JR西日本", "9022.T": "JR東海",
    "9064.T": "ヤマトHD", "9101.T": "日本郵船", "9104.T": "商船三井", "9107.T": "川崎汽船", "9147.T": "NXHD",
    "9201.T": "日本航空", "9202.T": "ANAHD", "9301.T": "三菱倉庫", "9412.T": "スカパーJ", "9432.T": "NTT",
    "9433.T": "KDDI", "9434.T": "ソフトバンク", "9501.T": "東京電力HD", "9502.T": "中部電力", "9503.T": "関西電力",
    "9531.T": "東京ガス", "9532.T": "大阪ガス", "9602.T": "東宝", "9613.T": "NTTデータG", "9735.T": "セコム",
    "9766.T": "コナミG", "9843.T": "ニトリHD", "9983.T": "ファーストリテイリング", "9984.T": "ソフトバンクG",
    ...
    with st.expander("リアルタイム指標", expanded=True):
        ...
        with col_btn:
            if st.button("🔄 指標更新"):
                ...
                st.rerun()
        with col_time:
            st.markdown(f"<div style='padding-top: 10px; color: #aaaaaa; font-size: 14px;'>更新日時: {now_jst}</div>", unsafe_allow_html=True)
