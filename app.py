...
st.markdown("""
    ...
    /* 指標更新ボタンの上下余白調整 */
    .update-btn-container div[data-testid="stButton"] button {
...
TICKER_NAME_MAP = {
    ...
    # 化学・医薬品
    "4004.T": "レゾナックHD", "4005.T": "住友化学", "4021.T": "日産化学", "4042.T": "東ソー", "4043.T": "トクヤマ",
    "4061.T": "デンカ", "4063.T": "信越化学", "4151.T": "協和キリン", "4183.T": "三井化学", "4188.T": "三菱ケミカルG",
    "4208.T": "UBE", "4452.T": "花王", "4901.T": "富士フイルム", "4911.T": "資生堂",
    "4502.T": "武田薬品", "4503.T": "アステラス製薬", "4506.T": "住友ファーマ", "4507.T": "塩野義製薬", "4519.T": "中外製薬",
    "4523.T": "エーザイ", "4543.T": "テルモ", "4568.T": "第一三共", "4578.T": "大塚HD",
    # 石油・ゴム・ガラス
    "5019.T": "出光興産", "5020.T": "ENEOS", "5101.T": "横浜ゴム", "5108.T": "ブリヂストン",
    "5201.T": "AGC", "5202.T": "日本板硝子", "5232.T": "住友大阪セメ", "5233.T": "太平洋セメ", "5301.T": "東海カーボン",
    "5332.T": "TOTO", "5333.T": "日本碍子",
    # 鉄鋼・非鉄・金属
    "5401.T": "日本製鉄", "5406.T": "神戸製鋼所", "5411.T": "JFE", "5541.T": "太平洋金属", "5706.T": "三井金属",
    "5711.T": "三菱マテリアル", "5713.T": "住友金属鉱山", "5714.T": "DOWA", "5801.T": "古河電気工業", "5802.T": "住友電気工業", "5803.T": "フジクラ",
    # 機械・電気機器
    "6103.T": "オークマ", "6113.T": "アマダ", "6146.T": "ディスコ", "6273.T": "SMC", "6301.T": "小松製作所",
    "6302.T": "住友重機械", "6305.T": "日立建機", "6326.T": "クボタ", "6361.T": "荏原製作所", "6367.T": "ダイキン工業",
    "6471.T": "日本精工", "6472.T": "NTN", "6473.T": "ジェイテクト", "6479.T": "ミネベアミツミ",
    "6501.T": "日立", "6503.T": "三菱電機", "6504.T": "富士電機", "6506.T": "安川電機", "6594.T": "ニデック",
    "6645.T": "オムロン", "6701.T": "NEC", "6702.T": "富士通", "6723.T": "ルネサス", "6724.T": "セイコーエプソン",
    "6752.T": "パナソニックHD", "6753.T": "シャープ", "6758.T": "ソニーグループ", "6762.T": "TDK", "6770.T": "アルプスアルパイン",
    ...
    # 輸送用機器
    "7011.T": "三菱重工業", "7012.T": "川崎重工業", "7013.T": "IHI", "7201.T": "日産自動車", "7202.T": "いすゞ自動車",
    "7203.T": "トヨタ自動車", "7205.T": "日野自動車", "7211.T": "三菱自動車工業", "7261.T": "マツダ", "7267.T": "ホンダ",
    "7269.T": "スズキ", "7270.T": "SUBARU", "7272.T": "ヤマハ発動機",
    # 精密・建設・商社
    "7731.T": "ニコン", "7733.T": "オリンパス", "7741.T": "HOYA", "7751.T": "キヤノン", "7752.T": "リコー", "7762.T": "シチズン時計",
    "1721.T": "コムシスHD", "1801.T": "大成建設", "1802.T": "大林組", "1803.T": "清水建設", "1808.T": "長谷工", "1812.T": "鹿島建設",
    "1925.T": "大和ハウス", "1928.T": "積水ハウス", "1963.T": "日揮HD",
    "8001.T": "伊藤忠", "8002.T": "丸紅", "8015.T": "豊田通商", "8031.T": "三井物産", "8035.T": "東京エレクトロン",
    "8053.T": "住友商事", "8058.T": "三菱商事", "2768.T": "双日",
    # 金融・不動産
    "8304.T": "あおぞら銀行", "8306.T": "三菱UFJ", "8308.T": "りそなHD", "8309.T": "三井住友トラスト", "8316.T": "三井住友FG",
    "8331.T": "千葉銀行", "8354.T": "ふくおかFG", "8411.T": "みずほFG", "5831.T": "しずおかFG", "7186.T": "コンコルディア",
    "8601.T": "大和証券G", "8604.T": "野村HD", "8591.T": "オリックス", "8725.T": "MS&AD", "8750.T": "第一生命HD",
    "8766.T": "東京海上HD", "8795.T": "T&D", "8630.T": "SOMPO",
    "8801.T": "三井不動産", "8802.T": "三菱地所", "8804.T": "東京建物", "8830.T": "住友不動産",
    # サービス・通信・他
    "2413.T": "エムスリー", "2432.T": "DeNA", "4307.T": "野村総研", "4324.T": "電通グループ", "4661.T": "OLC",
    "4689.T": "LINEヤフー", "4704.T": "トレンドマイクロ", "4751.T": "サイバーエージェント", "4755.T": "楽天グループ", "6098.T": "リクルートHD",
    "9735.T": "セコム", "9766.T": "コナミG", "3659.T": "ネクソン", "4188.T": "三菱ケミカルG",
    "9001.T": "東武鉄道", "9005.T": "東急", "9007.T": "小田急電鉄", "9008.T": "京王電鉄", "9009.T": "京成電鉄",
    "9020.T": "JR東日本", "9021.T": "JR西日本", "9022.T": "JR東海", "9101.T": "日本郵船", "9104.T": "商船三井", "9107.T": "川崎汽船",
    "9201.T": "日本航空", "9202.T": "ANAHD", "9301.T": "三菱倉庫",
    "9432.T": "NTT", "9433.T": "KDDI", "9434.T": "ソフトバンク", "9501.T": "東電HD", "9502.T": "中部電力", "9503.T": "関西電力",
    "9531.T": "東京ガス", "9532.T": "大阪ガス", "9602.T": "東宝", "9843.T": "ニトリHD", "9983.T": "ファーストリテイリング",
    "9984.T": "ソフトバンクG", "3086.T": "J.フロントリテイリング", "3092.T": "ZOZO", "3099.T": "三越伊勢丹", "3231.T": "野村不動産",
    "3289.T": "東急不動産", "3382.T": "セブン&アイ", "7832.T": "バンダイナムコHD", "7911.T": "TOPPAN", "7912.T": "大日本印刷",
    "7951.T": "ヤマハ", "7974.T": "任天堂", "8233.T": "高島屋", "8252.T": "丸井グループ", "8253.T": "クレディセゾン", "8267.T": "イオン",
    # 追加5銘柄
...
# --- タブ1: ワンタッチ (Ver 1.68 復旧 ＆ 指標更新ボタン移動 ＆ 上下余白均等) ---
with tab_top:
